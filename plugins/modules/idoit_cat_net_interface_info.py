...
- Sven Anders (@tabacha)
description: Gets C__CATG__NETWORK_INTERFACE category  values
extends_documentation_fragment:
- scaleuptechnologies.idoit.idoit_option
- scaleuptechnologies.idoit.category_options
module: idoit_cat_net_interface_info
options: {}
short_description: Get values from a net_interface category to an object
