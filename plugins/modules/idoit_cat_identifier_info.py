...
- Sven Anders (@tabacha)
description: Gets C__CATG__IDENTIFIER category  values
extends_documentation_fragment:
- scaleuptechnologies.idoit.idoit_option
- scaleuptechnologies.idoit.category_options
module: idoit_cat_identifier_info
options: {}
short_description: Get values from a identifier category to an object
